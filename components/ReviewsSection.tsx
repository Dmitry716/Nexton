...
const reviews: Review[] = [
  {
    ...
    name: "Алексей",
    car: "BMW X5",
    text: "Отличный сервис! Заправили автокондиционер, теперь дует ледяным. Спасибо мастерам! Приехал с жалобой на тёплый воздух — за час всё сделали. Давление в норме, фреон заправили, добавили краситель. Результатом очень доволен!",
    rating: 5,
    date: "15.04.2026",
  ...
  },
  {
    ...
    text: "Автокондиционер перестал охлаждать. Оказалось — микротрещина в трубке. Мастер быстро нашёл утечку с помощью течеискателя, запаяли на месте. Месяц уже — всё работает отлично. Цена адекватная.",
    rating: 5,
    date: "10.04.2026",
    service: "Ремонт трубок автокондиционера",
  },
  {
    id: 3,
    name: "Ольга",
    car: "Hyundai Solaris",
    text: "Делали бактериальную очистку автокондиционера. Раньше при включении стоял ужасный запах сырости. После обработки пеной — запах пропал полностью. В салоне стало приятно дышать. Рекомендую делать раз в год!",
    rating: 5,
    date: "25.03.2026",
  ...
  },
  {
    ...
    text: "Задний контур автокондиционера перестал работать — течь металлических трубок. Ребята заменили трубки на качественные шланги. Теперь задние пассажиры тоже с комфортом. Спасибо за оперативность!",
    rating: 5,
    date: "18.03.2026",
  ...
  },
  {
    ...
    name: "Андрей",
    car: "Audi A6",
    text: "Заменили радиатор автокондиционера — старый пробило камнем. Мастер предупредил, что нужно менять ещё осушитель и заправить всё заново. Цену озвучили до работы. Сделали аккуратно, автокондиционер теперь работает как новый.",
    rating: 5,
    date: "20.02.2026",
    service: "Замена конденсатора автокондиционера",
  },
  {
    id: 9,
    name: "Сергей",
  ...
  },
  {
    ...
    name: "Владимир",
    car: "Tesla Model 3",
    text: "Вытягивали вмятину на двери споттером, потом сразу под покраску. Металл выправили аккуратно, шпаклёвки минимум. После покраски перехода не видно.",
    rating: 5,
    date: "28.01.2026",
    service: "Удаление вмятин споттером",
  },
  {
    id: 15,
    name: "Роман",
    car: "Skoda Octavia",
    text: "Красили крыло и дверь после мелкого ДТП. Цвет попали точно, переход на соседнюю деталь не видно даже на солнце. Сдали в срок, как обещали. Буду обращаться ещё.",
    rating: 5,
    date: "18.03.2026",
  ...
  },
  {
    ...
    name: "Наталья",
    car: "Renault Kaptur",
    text: "Поменяли салонный фильтр и сделали полную бактериальную очистку системы кондиционирования. Запах плесени исчез, автокондиционер перестал сушить глаза. Цена приятно удивила. Буду рекомендовать друзьям!",
    rating: 5,
    date: "20.12.2025",
    service: "Бактериальная очистка",
  },
  {
    ...
    name: "Артём",
    car: "Mazda CX-5",
    text: "Делал промывку системы автокондиционера после замены компрессора на другом сервисе. Оказалось, старый компрессор рассыпался, и металлическая стружка осталась в системе. Промыли специальной станцией, заменили осушитель. Компрессор дольше проживёт. Спасибо за качественный подход!",
    rating: 5,
    date: "12.12.2025",
    service: "Промывка системы автокондиционера",
  },
];
