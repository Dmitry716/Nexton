...
export const metadata: Metadata = {
  ...
  description:
    "Автосервис и СТО Nexton в Полоцке и Новополоцке. Ремонтируем автокондиционеры и системы охлаждения, восстанавливаем кузов, обслуживаем бензиновые китайские авто. Диагностика подвески на вибростенде, вебасто, радиаторы, сварка. Гарантия до 6 месяцев. Звоните: +375297115091",
  openGraph: {
    title:
      "Автосервис Nexton в Полоцке и Новополоцке — климат, кузов и ходовая",
    description:
