...
import { getCategoryPageHref, hasCategoryLandingPage } from "@/data/categories";
...
export const metadata: Metadata = {
  title: "Автосервис Nexton в Полоцке и Новополоцке — климат, кузов и ходовая",
  description:
    "Автосервис Nexton в Полоцке и Новополоцке. Ремонтируем автокондиционеры и системы охлаждения, восстанавливаем кузов, обслуживаем бензиновые китайские авто. Диагностика подвески на вибростенде, вебасто, радиаторы, сварка. Гарантия до 6 месяцев. Звоните: +375297115091",
  openGraph: {
    title:
...
const categories = [
  {
    ...
    icon: Wind,
    description: "Диагностика, заправка и ремонт автокондиционеров",
  },
  {
    id: "otopiteli",
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                ремонте систем охлаждения и автокондиционеров, выполняем
                кузовной ремонт и обслуживаем китайские автомобили. За это время
                помогли тысячам автовладельцев в Полоцке, Новополоцке и области.
              </p>
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
              ...
              {/* <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#1e3a5f] dark:bg-[#7a9bcb]" />
                  Автокондиционеры, отопители, радиаторы, пневмосистемы
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#1e3a5f] dark:bg-[#7a9bcb]" />
              ...
              <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#1e3a5f] dark:bg-[#7a9bcb]" />
                  Кондиционеры, отопители, радиаторы, кузовные работы // 👈
                  ЗАМЕНИЛИ
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#1e3a5f] dark:bg-[#7a9bcb]" />
