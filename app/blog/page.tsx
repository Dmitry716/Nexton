...
export const metadata: Metadata = {
  ...
  description:
    "Полезные статьи по ремонту автокондиционеров, вебасто, радиаторов и систем охлаждения. Советы автовладельцам в Полоцке и Новополоцке.",
  keywords:
    "блог, статьи, ремонт кондиционеров, вебасто, радиаторы, Полоцк, Новополоцк",
  openGraph: {
    title: "Блог Nexton | Полезные статьи для автовладельцев",
    description:
      "Статьи по ремонту автокондиционеров, вебасто, радиаторов и систем охлаждения.",
        ...
        <div className="relative h-full flex items-center justify-center z-10">
          <div className="text-center text-white px-4 max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto">
              Полезные статьи по ремонту автокондиционеров, вебасто, радиаторов
              и систем охлаждения
            </p>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        >
          <h2 className="text-2xl font-bold text-black dark:text-white mb-3">
            Ремонт кондиционеров и систем охлаждения в Полоцке и Новополоцке
          </h2>
          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            В нашем блоге мы публикуем полезные статьи о ремонте
            автокондиционеров, вебасто, радиаторов и систем охлаждения. Здесь вы
            найдете советы по обслуживанию автомобиля, информацию о типичных
            неисправностях и способах их устранения. Мы работаем в Полоцке и
            Новополоцке с 2010 года и делимся своим опытом, чтобы помочь
            автовладельцам продлить срок службы своих автомобилей.
          </p>
        </footer>
      </div>
    </main>
