        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Автосервис и СТО в Полоцке и Новополоцке: кондиционеры, системы охлаждения, кузовной ремонт, бензиновые китайские авто, пневмосистемы, диагностика подвески, сварка.",
              url: "https://nexton.vip",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "Nexton",
              description:
                "Автосервис и СТО Nexton в Полоцке и Новополоцке: кондиционеры, кузов, китайские авто, охлаждение, диагностика подвески, сварка",
              potentialAction: {
                "@type": "SearchAction",
                target: {
                  "@type": "EntryPoint",
