...
export const metadata: Metadata = {
  ...
  description:
    "Профессиональный ремонт систем охлаждения, автокондиционеров, радиаторов в Полоцке и Новополоцке. Заправка кондиционеров, ремонт Webasto, аргонная сварка. Работаем с 2010 года. Звоните: +375297115091",
  keywords: [
